...
public class MobGoblin extends EntityZombie implements EquipEntity{
    ...
    private final List<String> tags = Arrays.asList("Undead", "Vile", "Angry", "Dreadful", "Short", "Smelly");
    
    private final List<Material> hand = Arrays.asList(Material.WOOD_AXE, Material.WOOD_SWORD, Material.WOOD_SPADE, Material.STONE_PICKAXE);
    ...
    private final List<Material> chestplate = Arrays.asList(Material.LEATHER_CHESTPLATE, Material.AIR);
    private final List<Material> leggings = Arrays.asList(Material.LEATHER_LEGGINGS, Material.AIR);
    private final List<Material> boots = Arrays.asList(Material.LEATHER_BOOTS, Material.AIR);
    
    public MobGoblin(World world, String name, MobTiers tier){
        super(world);
