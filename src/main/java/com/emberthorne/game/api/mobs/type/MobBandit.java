...
public class MobBandit extends EntitySkeleton implements EquipEntity{
    ...
    private final List<String> tags = Arrays.asList("Undead", "Vile", "Deadly", "Superior");
    
    private final List<Material> hand = Arrays.asList(Material.WOOD_AXE, Material.WOOD_SWORD, Material.STONE_SWORD);
    ...
    public MobBandit(World world, String name, MobTiers tier){
        super(world);
